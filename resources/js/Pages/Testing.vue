<template>
   <main class="h-auto flex items-center px-6 lg:px-32 bg-purple-900 text-white">
        <!-- <header class="w-full absolute left-0 top-0 p-6 lg:p-32">
            <div class="flex justify-between">
                <div>
                    <h1 class="text-3xl font-bold">Funtrivial</h1>
        ...
        <section class="w-full md:w-9/12 xl:w-8/12">
            <span class="font-bold uppercase tracking-widest">Funtrivial</span>
